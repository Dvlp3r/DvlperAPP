...
class UserStoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_story" do
    assert_difference('UserStory.count') do
      post user_stories_url, params: { user_story: { app: @user_story.app, attribute: @user_story.attribute, goal: @user_story.goal, persona: @user_story.persona, title: @user_story.title } }
    end
  ...
  test "should update user_story" do
    patch user_story_url(@user_story), params: { user_story: { app: @user_story.app, attribute: @user_story.attribute, goal: @user_story.goal, persona: @user_story.persona, title: @user_story.title } }
